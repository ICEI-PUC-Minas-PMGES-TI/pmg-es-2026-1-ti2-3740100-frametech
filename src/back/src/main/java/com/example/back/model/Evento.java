...
public class Evento {
    ...
    public void setServicosSelecionados(String servicosSelecionados) { this.servicosSelecionados = servicosSelecionados; }
    
    public String getEntregaSelecionada() { return entregaSelecionada; }
    public void setEntregaSelecionada(String entregaSelecionada) { this.entregaSelecionada = entregaSelecionada; }
    ...
    public void setQtdFotos(String qtdFotos) { this.qtdFotos = qtdFotos; }
    
    public String getReferencias() { return referencias; }
    public void setReferencias(String referencias) { this.referencias = referencias; }
    
    public String getTrabalhouAntes() { return trabalhouAntes; }
    public void setTrabalhouAntes(String trabalhouAntes) { this.trabalhouAntes = trabalhouAntes; }
    
    public String getAnexoReferencias() { return anexoReferencias; }
    public void setAnexoReferencias(String anexoReferencias) { this.anexoReferencias = anexoReferencias; }
