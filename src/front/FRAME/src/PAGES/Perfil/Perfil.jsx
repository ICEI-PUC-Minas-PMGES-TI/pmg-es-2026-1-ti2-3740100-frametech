...
const Perfil = () => {
    ...
    const handleTelefoneChange = (e) => {
        ...
        const erroTel = validarTelefone(formatado);
        setErroCampos((prev) => ({ ...prev, telefone: erroTel || "" }));
    };
        ...
        reader.onloadend = async () => {
            try {
                const res = await fetch(`${API_URL}/foto/${usuarioId}`, {
                    method: "PUT",
                    headers: { "Content-Type": "application/json" },
                    body: JSON.stringify({ fotoPerfil: reader.result })
                });
                        ...
                        <p>
                            ...
                            {isEditing ? (
                                <>
                                    ...
                                    />
                                    {erroCampos.telefone && (
                                        <span className="field-error">{erroCampos.telefone}</span>
                                    )}
                                </>
                            ) : (
